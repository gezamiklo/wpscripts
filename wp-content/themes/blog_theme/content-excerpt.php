<div class="entry">
    ...
    <div class="post-container">
        ...
        <div class="post-meta">
            ...
            <p class="post-comments"><a href="<?php echo get_permalink()?>#comments">Hozzászólások (<?php echo get_comments_number();?>)</a></p>
        </div>
        <p class="post-text">
            <?php the_excerpt();?>
            <a href="<?php the_permalink()?>" class="more-link">Tovább</a>
        </p>
    </div>
</div>